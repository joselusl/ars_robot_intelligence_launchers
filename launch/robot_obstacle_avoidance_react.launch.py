...
def generate_launch_description():
    ...
    ars_obstacle_avoidance_react_yaml_file_arg=DeclareLaunchArgument(
      ...
      default_value=PathJoinSubstitution(['ars_obstacle_avoidance_react', 'config_obstacle_avoidance_react.yaml']), 
    ...
    robot_cmd_raw_stamped_topic_arg = DeclareLaunchArgument(
        'robot_cmd_raw_stamped_topic', default_value='/robot_cmd_ctr_stamped',
    ...
    ars_obstacle_avoidance_react_conf_yaml_file = PathJoinSubstitution([FindPackageShare('ars_robot_intelligence_config'), 'config', LaunchConfiguration('config_param_obstacle_avoidance_react_yaml_file')])
    ...
    return LaunchDescription([
        ...
        GroupAction([
          ...
          GroupAction([
            PushRosNamespace('obstacle_avoidance_react'),
