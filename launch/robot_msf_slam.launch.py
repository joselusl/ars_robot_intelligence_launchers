...
def generate_launch_description():
    ...
    ars_msf_slam_yaml_file_arg=DeclareLaunchArgument(
      ...
      default_value=PathJoinSubstitution(['msf_slam', 'config_msf_slam.yaml']), 
    ...
    ars_msf_slam_conf_yaml_file = PathJoinSubstitution([FindPackageShare('ars_robot_intelligence_config'), 'config', LaunchConfiguration('config_param_msf_slam_yaml_file')])
