...
def generate_launch_description():
    ...
    ars_msf_state_estimator_yaml_file_arg=DeclareLaunchArgument(
      ...
      default_value=PathJoinSubstitution(['msf_state_estimator', 'config_msf_state_estimator.yaml']), 
      description='Path to the config_param_msf_state_estimator_yaml_file'
    )
    ...
    ars_msf_state_estimator_conf_yaml_file = PathJoinSubstitution([FindPackageShare('ars_robot_intelligence_config'), 'config', LaunchConfiguration('config_param_msf_state_estimator_yaml_file')])
    ...
    return LaunchDescription([
        ...
        GroupAction([
          ...
          GroupAction([
            PushRosNamespace('msf_state_estimator'),
